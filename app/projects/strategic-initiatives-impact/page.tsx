...
export default function StrategicInitiativesImpactPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        <div className="rounded-2xl overflow-hidden shadow-lg">
          <img 
            ...
            alt="Strategic Initiatives & Impact" 
        ...
        <div className="bg-white rounded-2xl border border-border p-8">
          ...
          <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden">
            <iframe
              ...
              title="Strategic Initiatives & Impact - Project Demo"
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-3 text-gray-700 leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>Reduced board meeting preparation time from 3 weeks to 9 days</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-secondary rounded-full mt-2 shrink-0" />
                <span>Established a structured 4-week investor data room preparation cycle with audit-ready documentation</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-secondary rounded-full mt-2 shrink-0" />
                <span>Aligned all five departments' roadmaps with clear quarterly milestones</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-secondary rounded-full mt-2 shrink-0" />
                <span>Career progression framework adopted by HR for 70+ employees with clear progression tracks, strengthening the organization's culture and retention</span>
              </li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold text-foreground mb-4">Quantified Outcomes</h3>
            <div className="flex flex-wrap gap-3">
              <span className="px-4 py-2 bg-primary/5 border border-primary/20 rounded-lg text-primary text-sm font-medium">
                57% faster board prep
              </span>
              <span className="px-4 py-2 bg-primary/5 border border-primary/20 rounded-lg text-primary text-sm font-medium">
                4-week data room cycle
              </span>
              <span className="px-4 py-2 bg-primary/5 border border-primary/20 rounded-lg text-primary text-sm font-medium">
